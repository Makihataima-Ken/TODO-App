"""
Django settings for AuthRegisterDjango project.
...
SECRET_KEY = 'django-insecure-zxqyft-*jhv7u#6@0pjp^unzi0@ilri8hl=(0@t4n9%r!ucfry'
...
ROOT_URLCONF = 'AuthRegisterDjango.urls'
...
WSGI_APPLICATION = 'AuthRegisterDjango.wsgi.application'
